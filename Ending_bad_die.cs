...
public class Ending_bad_die : MonoBehaviour
{
    ...
    IEnumerator TextPractice()
    {
        ...
        yield return StartCoroutine(NormalChat("옥슈슈", "너무... 아파... "));
        yield return StartCoroutine(NormalChat("옥슈슈", "나.... 콘치즈가.... 되고 싶었는데....."));
        yield return StartCoroutine(NormalChat("옥슈슈", "(끝내 숨을 거두었다.)"));
        yield return StartCoroutine(NormalChat("Ending", "BAD ENDING <체력을 내 목숨같이>"));
