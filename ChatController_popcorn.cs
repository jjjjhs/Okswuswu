...
public class ChatController_popcorn : MonoBehaviour
{
    ...
    IEnumerator TextPractice()
    {
        ...
        yield return StartCoroutine(NormalChat("옥슈슈", "불에 닿아..... 팝콘이 되어버렸어....."));
        yield return StartCoroutine(NormalChat("옥슈슈", "나.... 콘치즈가.... 되고 싶었는데....."));
        yield return StartCoroutine(NormalChat("옥슈슈", "(끝내 숨을 거두었다.)"));
        yield return StartCoroutine(NormalChat("Ending", "BAD ENDING <팝콘이 되기 싫어>"));

    }
}


// SceneManager.LoadScene(Ending_popcorn_Fade);
//            if (isButtonClicked)
//            {
